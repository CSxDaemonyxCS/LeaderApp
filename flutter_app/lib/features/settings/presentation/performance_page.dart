...
/// Nested Settings screen (`/more/performance`): animation/graphics quality
/// and display frame rate — the device-performance controls previously on
/// the Settings hub.
///
/// Moved, not rebuilt: both pickers below read and write the exact same
/// `motionLevelProvider` / `frameRateProvider` the hub used, so persistence,
/// the motion-level definitions, OS reduce-motion handling, and the
/// frame-rate/display-capability integration are unchanged.
class PerformancePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text(S.settingsPerformanceTitle)),
...
/// The five-step animation quality picker.
///
/// Ordered cheapest to richest so the row reads as one scale, and every
/// step explains what it actually costs — the choice is about the device in
/// the user's hand, not about taste.
